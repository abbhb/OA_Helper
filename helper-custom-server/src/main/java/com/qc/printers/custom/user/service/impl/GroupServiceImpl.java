...
import com.qc.printers.common.user.mapper.GroupMapper;
...
public class GroupServiceImpl extends ServiceImpl<GroupMapper, Group> implements GroupService {
    ...
    public GroupServiceImpl(GroupUserService groupUserService) {
    ...
    public PageData<GroupAndUserFrontVO> queryGroup(Integer pageNum, Integer pageSize, String name) {
        ...
        pageInfo.getRecords().forEach(group -> {
            ...
            list.forEach(groupUser -> {
                ...
                User byId = iUserService.getById(groupUser.getUserId());
                if (byId != null) {
            ...
            groupAndUserFrontVO.setCreateUserName(iUserService.getById(group.getCreateUser()).getName());
