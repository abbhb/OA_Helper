...
public class PropertiesUtils {
    ...
    public static Map<String, String[]> widgetDataType;

    public static Map<String, Map.Entry<String, Integer>> defaultWidgetDataType;
    ...
    public void loadGlobalVariables() {
        PropertiesUtils.widgetDataType = PropertiesUtils.getWidgetDataType("MySQL");
        PropertiesUtils.defaultWidgetDataType = PropertiesUtils.getDefaultWidgetDataType("MySQL");
    }
}
