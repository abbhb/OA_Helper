...
public class FrequencyControlAspect {
    ...
    @Around("@annotation(com.qc.printers.common.common.annotation.FrequencyControl)||@annotation(com.qc.printers.common.common.annotation.FrequencyControlContainer)")
