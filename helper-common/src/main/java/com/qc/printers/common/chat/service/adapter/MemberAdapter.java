...
public class MemberAdapter {
    ...
    public static List<ChatMemberListResp> buildMemberList(List<UserInfo> memberList) {
    ...
    public static List<ChatMemberListResp> buildMemberList(Map<Long, UserInfo> batch) {
